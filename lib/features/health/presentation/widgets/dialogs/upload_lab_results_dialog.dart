  ...
  Future<void> _pickPDF(BuildContext context) async {
    try {
      ...
      if (context.mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(AppLocalizations.of(context)!.failedToPickPdf('$e')),
          ),
        );
      }
    }
      ...
      child: Column(
        ...
        children: [
          ...
          _buildOptionButton(
            ...
            subtitle: t.chooseFromGalleryDesc,
