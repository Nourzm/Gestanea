  ...
  group('GradientPillButton', () {
    testWidgets('renders the label and fires onPressed', (tester) async {
      ...
      await tester.pumpWidget(_wrap(
        GradientPillButton(label: 'Continue', onPressed: () => taps++),
      ));
    ...
    testWidgets('hides label and shows a spinner while isLoading', (tester) async {
      await tester.pumpWidget(_wrap(
    ...
    testWidgets('disables tap when onPressed is null', (tester) async {
      await tester.pumpWidget(_wrap(
        const GradientPillButton(label: 'Disabled', onPressed: null),
      ));
